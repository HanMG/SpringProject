...
public class FoodReviewDto {
	...
	public FoodReviewDto(String reviewCode, String memberCode, String memberName, int reviewCount, Date reviewDate,
			String reviewCont, int reviewScore, List<ImageDto> imageList) {
		super();
	...
	public String toString() {
		return "FoodReviewDto [reviewCode=" + reviewCode + ", memberCode=" + memberCode + ", memberName=" + memberName
				+ ", reviewCount=" + reviewCount + ", reviewDate=" + reviewDate + ", reviewCont=" + reviewCont
				+ ", reviewScore=" + reviewScore + ", imageList=" + imageList + "]";
	}
