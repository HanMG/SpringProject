...
function kindChange(text){
	...
	let kor = ["회","해장국/국밥","해물탕/해물요리/꽃게","한정식","파전/모듬전/빈대떡","치킨/훈제","철판구이/볶음밥","찌개/전골/국/탕","찌개/전골/국/탕","죽","족발/보쌈","전복","오리 훈제/구이/로스/탕","순두부","순대국","설렁탕/곰탕/도가니탕","삼계탕/백숙/찜닭","삼겹살/목살","비빔밥/돌솥밥/쌈밥","불고기/갈비살/차돌박이","라면/칼국수/국수/수제비","떡볶이/순대/튀김/만두","떡","돼지갈비/갈매기살","닭볶음탕/닭갈비/닭발","냉면","낙지","꽃등심/등심/육회","그밖에또다른것"];
	let chn = ["중국음식","그밖에또다른것"];
	let jp = ["일본음식/초밥","씨푸드","샤브샤브","그밖에또다른것"];
	let west = ["햄버거","프렌치레스토랑","퓨전레스토랑","패스트푸드","패밀리레스토랑","지중해음식","이태리레스토랑","유로피언레스토랑","스테이크하우스","브런치","돈가스","남미음식","그밖에또다른것"];
